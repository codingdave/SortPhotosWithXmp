...
internal abstract class CommandBase
{
    ...
    protected CommandBase(ILogger<CommandLine> logger, CommandlineOptions commandlineOptions)
    {
        Logger = logger;
    ...
    protected void Run(IRun f)
    {
        try
        {
            ...
            {
                statistics.FileErrors.HandleErrorFiles(Logger, filesFoundStatistics);
            }
            statistics.Log();
        }
        catch (Exception e)
